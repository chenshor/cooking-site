  ...
  <b-container class="container1">
    <div class="title">
      <img
        width="1140"
        height="641"
        src="https://res.cloudinary.com/di0zdzniy/image/upload/v1594462456/mainFood_fp7mst.jpg"
        alt="Image"
      />
    </div>
    <div align-h="between" class="rows">
      <div class="columns">
