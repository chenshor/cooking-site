        ...
        <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
          ...
          >
            ...
            >
              ...
              <strong>strong</strong>. <br />For that, your password should be
              also:
            </b-form-text>
            <b-form-invalid-feedback
            ...
            <b-form-invalid-feedback
              ...
              >containe at least one letter, one number and special
          ...
          >
          <br />
          <b-button id="resetbtn" type="reset" class="ml-5 w-40"
            >Reset</b-button
          >
          <div class="mt-2">
