  ...
  <div class="container">
    ...
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      ...
      >
        ...
        <b-form-invalid-feedback v-if="!$v.form.username.alpha">Username must contains only letters</b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        >firstName must contains only letters</b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        ></b-form-input>
        <b-form-invalid-feedback v-if="!$v.form.lastName.alpha">lastName must contains only letters</b-form-invalid-feedback>
      </b-form-group>
      ...
      >
        ...
        <b-form-invalid-feedback
          v-if="$v.form.password.required && (!$v.form.password.num && !$v.form.password.char)"
        >containe at least one letter and one number</b-form-invalid-feedback>
      </b-form-group>
  ...
  validations: {
    form: {
      ...
      password: {
        ...
        char: c => !c.match(/^[A-Z,a-z,0-9]*$/),
        num: n => !(n.match(/\d+/g) === null)
      },
      confirmedPassword: {
        required,
    ...
    async Register() {
      try {
        const response = await this.axios.post(
          "https://ass3-2.herokuapp.com/register",
          {
